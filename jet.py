...
RedNoiseL,RandomSeed,aliasTbin, tbin, Age = 100,12,100,100,1000
N = Age / tbin
...
for i in range(len(flux)):
	...
	plt.plot(energies, energies*energies*ncr)
	plt.loglog()
	plt.xlim(1e15,1e21)
	#plt.ylim(1e13,1e19)

	plt.subplot(224)
	plt.plot(energies, energies*energies*escaping*delta_t)
